...
export default defineConfig({
  plugins: [
    ...
    VitePWA({
      ...
      includeAssets: ['icons/*.svg', 'models/**/*'],
      manifest: {
        ...
        shortcuts: [
          { name: 'Bater Ponto', short_name: 'Ponto', url: '/', icons: [{ src: '/icons/icon-192x192.svg', sizes: '192x192' }] },
          { name: 'Admin', short_name: 'Admin', url: '/admin', icons: [{ src: '/icons/icon-192x192.svg', sizes: '192x192' }] },
        ],
      },
      workbox: {
